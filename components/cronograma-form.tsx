        ...
        <Table>
          <TableHeader>
            <TableRow>
              ...
              {digitos.map((digito) => (
                <TableHead key={digito.valor} className="text-center font-bold min-w-[120px]">
                  {digito.label}
                </TableHead>
              ))}
            </TableRow>
          ...
          <TableBody>
            {meses.map((mes, mesIndex) => (
              <TableRow key={mes} className={mesIndex % 2 === 0 ? "bg-blue-50" : ""}>
                <TableCell className="font-medium text-red-600">{mes}</TableCell>
                {digitos.map((digito) => {
